...
<br><br>
<img src="https://latex.codecogs.com/svg.image?\theta_{t}^{shared}&space;-&space;\eta&space;^{shared}&space;\times&space;g_{i,&space;t}&space;=&space;\theta&space;_{t&plus;1,&space;i}^{local}" title="\theta_{t}^{shared} - \eta ^{shared} \times g_{i, t} = \theta _{t+1, i}^{local}" />
<br><br>
